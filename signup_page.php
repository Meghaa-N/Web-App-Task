...
<title>Murugan Bhavan | SIGNUP</title>
<style>

#contain
  {
    border:10px double #1a1814;
...
<body style="background-color:#1a1814 ">
  <section class="ftco-section ftco-no-pb ftco-no-pt"  >
<div class="container" id="contain" >
<!--<div class="row">-->
<div class="try" style="padding:10%">
<!--<div class="login-wrap p-4 p-md-5">-->
<h3 class="mb-4" style="text-align: center;color:#1a1814">Register Now</h3>
...
<div class="form-group">
<label class="label" for="email" name="address" style="color:#010217" required>Address<span style='color: red'>*</span></label>
<input type="text" class="form-control" required="[a-zA-Z-]" name="address" placeholder="Address">
</div>
<div class="form-group">
